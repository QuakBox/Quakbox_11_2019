 ...
 **/
	...
	$root_folder_path="/var/www/html";
	$site_name="Quakbox";
	$site_email="noreply@quakbox.com";
	$site_email_add="@quakbox.com";
	...
	if(isset($_SESSION['SESS_MEMBER_ID']))
	{
		...
		$mailPassword = $_SESSION['password'];
		//$mailUsername = $_SESSION['qbemail']."@quakbox.com";
		$mailUsername = $_SESSION['qbemail'];
		//echo "<br>Cmd is:"."/usr/local/cpanel/bin/uapi  Email add_pop email=$mailUsername password=$mailPassword domain=quakbox.com quota=20 skip_update_db=1";
		//exec("/scripts/addpop $mailUsername $mailPassword 100");
		exec("/usr/local/cpanel/bin/uapi  Email add_pop email=$mailUsername password=$mailPassword domain=quakbox.com quota=20 skip_update_db=1");
...
<br>
Email_id: ".$Username."@".$site_email_add." or<br>
