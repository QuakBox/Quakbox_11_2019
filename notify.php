...
if (isset($_POST['login_submit'])) {
    ...
    $redirect = NULL;
	//echo "<br>".$insertQuery = "INSERT INTO `notify_user` ( `name`, `email`, `ip`) VALUES ('".$name."', '".$email."', '".$ip."')";
    
    //$query = mysqli_query($con, $insertQuery) or die( mysqli_error($con)));
	if (!mysqli_query($con,"INSERT INTO `notify_user` ( `name`, `email`, `ip`) VALUES ('".$name."', '".$email."', '".$ip."')"))
  {
...
<div class="container">
	...
	<h2><?php echo $message;?></h2>
        ...
        <?php  /*?><div class="col-md-5 col-md-offset-3">
